  ...
  return (
    <div className="pt-24 px-6 pb-24 max-w-5xl mx-auto">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-2xl font-serif text-orange-950 font-bold">Gestion DailyGlow</h1>
        <button className="bg-orange-950 text-white p-2 rounded-full">
          <Plus size={24} />
        </button>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
        <div className="bg-orange-50 p-4 rounded-2xl border border-orange-100">
          <BarChart3 size={18} className="text-orange-700 mb-2" />
          <p className="text-xs text-gray-500 uppercase">Clics WhatsApp</p>
          <p className="text-xl font-bold">84</p>
        </div>
        <div className="bg-orange-50 p-4 rounded-2xl border border-orange-100">
          <Package size={18} className="text-orange-700 mb-2" />
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-orange-50 overflow-hidden">
        <div className="divide-y divide-orange-50">
          {[
            ...
            <div key={idx} className="p-4 flex justify-between items-center hover:bg-orange-50/30 transition">
              <div>
                <p className="text-sm font-medium text-orange-950">{item.name}</p>
                <p className="text-xs text-orange-700 font-bold">{item.price} FCFA</p>
              </div>
      ...
      <div className="mt-10 p-4 bg-black rounded-2xl text-white">
        <p className="text-[10px] uppercase tracking-widest text-orange-300 mb-1">Status Écosystème</p>
