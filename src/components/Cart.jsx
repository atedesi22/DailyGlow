...
export default function Cart({ onBackToShop, cart, onRemoveFromCart }) {
  // Calcul de la somme totale
  // Correction pour accepter chaînes ou nombres sans crasher
    ...
    <div className="min-h-screen bg-[#FFF0F0] pt-28 px-6 pb-20 text-[#2B0F1A]">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          <button onClick={onBackToShop} className="p-2 hover:bg-white rounded-full transition-colors text-[#2B0F1A]">
            <ArrowLeft size={20} />
          </button>
