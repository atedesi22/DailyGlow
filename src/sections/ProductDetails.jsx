...
export default function ProductDetails({ product, onBack }) {
  return (
    <div className="pt-20 px-6 pb-32">
      ...
      <div className="aspect-[4/5] bg-pink-50 rounded-3xl overflow-hidden mb-8">
      ...
      <button className="fixed bottom-24 left-6 right-6 bg-pink-950 text-white py-4 rounded-2xl flex items-center justify-center gap-3">
